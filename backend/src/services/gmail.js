...
/**
 * Get a Gmail client instance using OAuth2 credentials from environment.
 */
...
/**
 * List recent unread messages or search with a query.
 * @param {string} [query='is:unread'] - Gmail search query
 */
async function listMessages(query = 'is:unread') {
  try {
...
module.exports = { listMessages, getMessageContent };
